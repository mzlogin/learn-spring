...
//    private CalleeService calleeService;
    ...
    // Case 12: Autowired + 匹配 Bean name 的变量名
    // 运行结果：正常
//    @Autowired
//    private CalleeService callee1ServiceImpl;

    // Case 13: Autowired + 不匹配 Bean name 的变量名
    // 运行结果：异常
...
//    private CalleeService calleeService;
    ...
    // Case 14: Autowired + 匹配 Bean name 的变量名 + Qualifier 匹配同一个 Bean name 的变量名
    // 运行结果：正常
//    @Autowired
//    @Qualifier("callee1ServiceImpl")
//    private CalleeService callee1ServiceImpl;

    // Case 15: Autowired + 匹配 Bean name 的变量名 + Qualifier 匹配另一个 Bean name 的变量名
    // 运行结果：正常
